...
const navigation = [
    ...
    { id: 3, name: 'Explore', href: '/explore', icon: MagnifyingGlassIcon, current: false },
    { id: 4, name: 'Profile', href: '/profile', icon: UserIcon, current: false },
...
export default function BottomNav(props: {index: number}) {
    ...
    return (
        <nav className="flex flex-1 w-full fixed bottom-0 left-0 right-0 bg-white shadow-lg z-50">
