...
import { TRANSACTION_MUTATEDB_ROUTE } from "@/lib/api/constant";
...
export default function CommonStepperPost({accounts, digest, transactionDigest, step, onBackChange, session, paid, metadata, free}
    : 
