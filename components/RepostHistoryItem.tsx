...
import { AccessDB, ReplyAccessDB, RepostAccessDB } from '@/types/transaction'
import { ChevronRightIcon } from '@heroicons/react/20/solid'
import Image from 'next/image'
import { useEffect, useState } from 'react'


export default function RepostHistoryItem({ repost }: {repost : RepostAccessDB}) {
    ...
    let price = parseInt(repost.price)
    let decimalPrice = '0'
    if (price > 0) {
    ...
    return (
        <div key={repost.id} className="relative flex group justify-between gap-x-2 items-center hover:bg-gray-50">
