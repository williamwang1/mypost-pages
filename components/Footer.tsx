...
const Footer = () => (
    <footer className="p-4 bg-white fixed bottom-0">
        <div className="mx-auto">
            <hr className="" />
            <div className="flex flex-1 flex-col items-center w-screen mt-2 lg:mt-5">
                <div className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://truefans.tech" className="hover:underline">MyPost™</a>. All rights Reserved.
                </div>
                <div className="flex mt-2 lg:mt-5 space-x-6 sm:justify-center">
